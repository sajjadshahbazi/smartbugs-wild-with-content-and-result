...
from tensorflow.keras.layers import Conv1D, ZeroPadding1D, Attention, LeakyReLU, UpSampling1D, Concatenate, Dropout, ZeroPadding1D, GlobalAveragePooling1D, Activation, Bidirectional, concatenate, Cropping2D, MaxPooling2D, MaxPooling1D, UpSampling2D, concatenate, Flatten, Dense, LSTM, Input, Reshape, BatchNormalization, Add
...
def train_LSTM():
    ...
    print(f"Shape of Y: {Y.shape}")  # باید (samples,) باشه
    ...
    model = Sequential([
        ...
        LSTM(64),  # ساده یک طرفه مثل مقاله پایه
        Dropout(0.5),
