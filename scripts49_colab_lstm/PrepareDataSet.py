...
from tensorflow.keras.layers import Conv1D, ZeroPadding1D, Attention, LeakyReLU, UpSampling1D, Concatenate, Dropout, ZeroPadding1D, GlobalAveragePooling1D, Activation, Bidirectional, concatenate, Cropping2D, MaxPooling2D, MaxPooling1D, UpSampling2D, Flatten, Dense, Bidirectional, LSTM, Input, Reshape, BatchNormalization, Add, MultiHeadAttention
