...
# =============================================================================
# اصلاح ۱: حذف تعریف تکراری تابع clean_fragment_without_remove_line
# در کد اصلی این تابع دو بار با محتوای یکسان تعریف شده بود.
# در Python نسخه دوم نسخه اول را کاملاً override می‌کند.
# این یک bug پنهان است - کد اجرا می‌شود اما نسخه اول هرگز استفاده
# نمی‌شود. اکنون فقط یک نسخه نگه داشته شده است.
#
# اصلاح ۲: حذف rx_comment
# این متغیر (re.compile('\*/\s*$')) در هر بار فراخوانی تابع
# تعریف می‌شد اما هیچ‌جا در کد استفاده نمی‌شد.
# حذف آن هیچ تاثیری بر رفتار کد ندارد.
# =============================================================================
