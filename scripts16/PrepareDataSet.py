...
def train_LSTM():
    ...
    # X, Y = smote.fit_resample(X.reshape(X.shape[0], -1), Y)  # X را دوبعدی کنید
    # X = X.reshape(-1, X.shape[1] // (vector_length * sequence_length), vector_length)  # بازگشت به شکل اصلی
    # print("After SMOTE - Distribution in Y:", np.unique(Y, return_counts=True))
...
if __name__ == "__main__":
    ...
    train_LSTM()
# Epoch 1/10
# 15433/15433 - 530s - 34ms/step - accuracy: 0.9765 - loss: 0.0074 - val_accuracy: 0.9782 - val_loss: 0.0067
# Epoch 2/10
# 15433/15433 - 514s - 33ms/step - accuracy: 0.9782 - loss: 0.0065 - val_accuracy: 0.9786 - val_loss: 0.0063
# Epoch 3/10
# 15433/15433 - 517s - 34ms/step - accuracy: 0.9787 - loss: 0.0062 - val_accuracy: 0.9780 - val_loss: 0.0061
# Epoch 4/10
# 15433/15433 - 526s - 34ms/step - accuracy: 0.9789 - loss: 0.0059 - val_accuracy: 0.9785 - val_loss: 0.0059
# Epoch 5/10
# 15433/15433 - 465s - 30ms/step - accuracy: 0.9790 - loss: 0.0057 - val_accuracy: 0.9788 - val_loss: 0.0057
# Epoch 6/10
# 15433/15433 - 472s - 31ms/step - accuracy: 0.9793 - loss: 0.0056 - val_accuracy: 0.9789 - val_loss: 0.0059
# Epoch 7/10
# 15433/15433 - 527s - 34ms/step - accuracy: 0.9794 - loss: 0.0054 - val_accuracy: 0.9791 - val_loss: 0.0055
# Epoch 8/10
# 15433/15433 - 528s - 34ms/step - accuracy: 0.9796 - loss: 0.0053 - val_accuracy: 0.9789 - val_loss: 0.0053
# Epoch 9/10
# 15433/15433 - 523s - 34ms/step - accuracy: 0.9798 - loss: 0.0051 - val_accuracy: 0.9792 - val_loss: 0.0053
# Epoch 10/10
# 15433/15433 - 542s - 35ms/step - accuracy: 0.9799 - loss: 0.0051 - val_accuracy: 0.9796 - val_loss: 0.0052
# 4287/4287 ━━━━━━━━━━━━━━━━━━━━ 62s 14ms/step
# Accuracy: 0.9807840907434137
# Classification Report:
#               precision    recall  f1-score   support
#
#         Safe       0.98      1.00      0.99    133441
#   Vulnerable       0.83      0.37      0.51      3737
#
#     accuracy                           0.98    137178
#    macro avg       0.91      0.68      0.75    137178
