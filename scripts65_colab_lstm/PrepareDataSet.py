...
def build_unet_bilstm_model(seq_len=sequence_length, vec_len=vector_length):
    ...
    combined = Dropout(0.3)(combined)              # اضافه شد: Dropout بعد از ترکیب
    dense1 = Dense(64, activation='relu')(combined)  # کاهش یافت: از 128 به 64
    dense2 = Dense(32, activation='relu')(dense1)     # کاهش یافت: از 64 به 32
